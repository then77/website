...
const PyIcon = styled(SiPython)`
  ${tw`py-3 px-3.5 bg-secondary-dark text-secondary-light shadow rounded-md transition-all cursor-pointer`}
  :hover {
    ${tw`bg-cyan-600 text-primary-light`}
    transform:scale(1.1);
  }
`;
...
const JsIcon = styled(SiJavascript)`
  ${tw`py-3 px-3.5 bg-secondary-dark text-secondary-light shadow rounded-md transition-all cursor-pointer`}
  :hover {
    ${tw`bg-yellow-500 text-gray-800`}
    transform:scale(1.1);
  }
`;
...
const TsIcon = styled(SiTypescript)`
  ${tw`py-3 px-3.5 bg-secondary-dark text-secondary-light shadow rounded-md transition-all cursor-pointer`}
  :hover {
    ${tw`bg-blue-700 text-primary-light`}
    transform:scale(1.1);
  }
`;
...
const HtmlIcon = styled(SiHtml5)`
  ${tw`py-3 px-3.5 bg-secondary-dark text-secondary-light shadow rounded-md transition-all cursor-pointer`}
  :hover {
    ${tw`bg-orange-600 text-primary-light`}
    transform:scale(1.1);
  }
`;
...
const NodeIcon = styled(SiNodedotjs)`
  ${tw`py-3 px-3.5 bg-secondary-dark text-secondary-light shadow rounded-md transition-all cursor-pointer`}
  :hover {
    ${tw`bg-green-600 text-primary-light`}
    transform:scale(1.1);
  }
`;
...
const TwIcon = styled(SiTailwindcss)`
  ${tw`py-3 px-3.5 bg-secondary-dark text-secondary-light shadow rounded-md transition-all cursor-pointer`}
  :hover {
    ${tw`bg-sky-600 text-primary-light`}
    transform:scale(1.1);
  }
`;
...
const NextIcon = styled(SiNextdotjs)`
  ${tw`py-3 px-3.5 bg-secondary-dark text-secondary-light shadow rounded-md transition-all cursor-pointer`}
  :hover {
    ${tw`bg-neutral-950 text-primary-light`}
    transform:scale(1.1);
  }
`;
...
const SqlIcon = styled(SiSqlite)`
  ${tw`py-3 px-3.5 bg-secondary-dark text-secondary-light shadow rounded-md transition-all cursor-pointer`}
  :hover {
    ${tw`bg-cyan-800 text-primary-light`}
    transform:scale(1.1);
  }
`;
...
export default function SkillContainer() {
  return (
    <>
      <div css={tw`mt-8 grid grid-cols-3 sm:grid-cols-6 gap-3`}>
